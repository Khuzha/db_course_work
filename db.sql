...
CREATE TABLE objects.rooms (
    ...
    faculty_id smallint REFERENCES objects.hostels(id) CONSTRAINT rooms_hostel_fkey NOT NULL,
...
CREATE TABLE objects.accesses (
    ...
    role_id smallint REFERENCES objects.roles(id) CONSTRAINT accesses_role_fkey NOT NULL,
...
CREATE TABLE users.admins (
    ...
    hostel_id smallint REFERENCES objects.hostels(id) CONSTRAINT admins_hostel_fkey NOT NULL,
...
CREATE TABLE users.lodgers (
    ...
    faculty_id smallint REFERENCES objects.faculties(id) CONSTRAINT lodgers_faculty_fkey NOT NULL,
...
CREATE TABLE objects.points (
    ...
    type smallint REFERENCES objects.point_types(id) CONSTRAINT points_point_type_fkey NOT NULL,
    date timestamp CONSTRAINT points_date NOT NULL,
